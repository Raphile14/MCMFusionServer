...
module.exports = class VoteDatabase {
    ...
    async init() {
        ...
        //////////////////////////////////////
        this.doc = new GoogleSpreadsheet(process.env.GOOGLE_FILE_LINK || '1aLgR4UJulSD8N2-AoYk1kVk3wocRWEr-Z1G5TT1mHW0');
        // use service account creds
        await this.doc.useServiceAccountAuth({
            client_email: (process.env.GOOGLE_SERVICE_ACCOUNT_EMAIL || "sheets@mcm-fusion-server-database.iam.gserviceaccount.com"),
